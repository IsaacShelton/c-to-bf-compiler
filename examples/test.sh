...
"$self/../peck" "$self/call_self_do_while_break.peck" "$self/call_self_do_while_break.rlebf"
"$self/../peck" "$self/call_self_do_while_continue.peck" "$self/call_self_do_while_continue.rlebf"
"$self/../peck" "$self/call_self_for.peck" "$self/call_self_for.rlebf"
"$self/../peck" "$self/call_self_for_break.peck" "$self/call_self_for_break.rlebf"
...
"$self/../peck" "$self/fib.peck" "$self/fib.rlebf"
"$self/../peck" "$self/for.peck"
"$self/../peck" "$self/for_break.peck"
"$self/../peck" "$self/for_continue.peck"
...
"$self/../peck" "$self/return_void.peck"
...
"$self/../peck" "$self/struct_zero_initializer.peck"
...
"$self/../peck" "$self/type_alias.peck"
